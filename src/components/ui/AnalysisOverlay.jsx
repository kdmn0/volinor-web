        ...
        <motion.div
          ...
          <div
            style={{
              ...
              boxShadow: "0 0 40px rgba(0, 229, 255, 0.06), inset 0 1px 0 rgba(0,229,255,0.08)",
            }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "14px" }}>
              ...
              <div>
                <div
                  ...
                  style={{ fontSize: "13px", color: "#00e5ff" }}>
            ...
            <div style={{ position: "relative", height: "2px", background: "rgba(0,229,255,0.06)", borderRadius: "1px", overflow: "hidden" }}>
              <motion.div
                animate={{ x: ["-100%", "200%"] }}
