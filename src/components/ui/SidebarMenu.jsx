...
const NAV_ITEMS = [
  ...
  {
    label: "MODEL KÜTÜPHANESİ",
    url: "/model-kutuphanesi",
    id: "model-kutuphanesi",
  },
  {
    label: "VİDEO KÜTÜPHANESİ",
    url: "/video-kutuphanesi",
    id: "video-kutuphanesi",
  },
  { label: "REFERANSLAR", url: "/referanslar", id: "referanslar" },
  {
    label: "SERTİFİKA VE PATENTLER",
    url: "/sertifika-ve-patentler",
    id: "sertifika-ve-patentler",
  },
      ...
      {isNavOpen && (
        <motion.div
          ...
          {NAV_ITEMS.map((item, i) => {
            const isActive =
              activePage === item.id || activePage === item.label; // Backward compatibility check just in case
            return (
              <motion.div
                key={item.id}
