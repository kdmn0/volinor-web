            ...
            return (
              <motion.div
                ...
                <Link
                  ...
                  className={`font-display text-base md:text-sm tracking-[0.2em] md:tracking-[0.25em] font-semibold transition-all duration-300 relative group w-full whitespace-nowrap min-h-[44px] flex items-center ${isActive ? "text-[#ffb800] drop-shadow-[0_0_8px_rgba(255, 184, 0,0.5)]" : "text-white/50 hover:text-white"}`}>
                  <div
                    className={`absolute -left-6 top-1/2 -translate-y-1/2 w-[2px] transition-all duration-300 rounded-full ${isActive ? "h-8 bg-[#ffb800] shadow-[0_0_15px_#ffb800]" : "h-0 bg-[#ffb800]/50 group-hover:h-6 group-hover:bg-[#ffb800] group-hover:shadow-[0_0_10px_#ffb800]"}`}
                  />
